			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="panel panel-info shadow p-3 mb-5">
					...
					<div class="panel-body">
						...
						%>
						<div class="alert alert-danger" id="danger">Your Balance Is
							insuficent.</div>
						<%
						}
						%>
						...
						%>
						<div class="alert alert-info" id="info">Transfer Successful Remain balance <%=success %></div>
						<%
						session.removeAttribute("success");
						}
						%>
						
						<form action="CustomerTransfer" method="post">
