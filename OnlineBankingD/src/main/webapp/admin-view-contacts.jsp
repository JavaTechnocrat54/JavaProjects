					...
					<table class="table">
						...
						<tbody>
							<tr>
								...
								<td><a href="AdminRemoveContact?custId=<%=resultset.getInt("contact_id") %>" class="btn btn-sm btn-danger text-whitez" onclick="return confirm('Are you sure do you want to delete this customer?');"><i class="fa fa-trash"></i> Delete</a></td>
							</tr>
						</tbody>
						<%
							}
