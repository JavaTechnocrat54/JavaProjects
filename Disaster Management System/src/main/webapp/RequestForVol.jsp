...
<body>
	...
	<div class="container">
		...
		<div class="panel panel-info shadow p-3 mb-5">
			<div class="panel-heading">Request For Volunteer Work </div>
			<div class="panel-body">
				...
				<%
								...
								%>
								<div class='alert alert-success' id='success'>Request IS Send Wait For Admin Response.</div>
								<%
									}
								%>
			<form action="CustomerVolunterr" method="post">
					<div class="form-group">
										<label for="cpassword">Customer ID:</label> <input
											type="text" class="form-control" id="cpassword"
											placeholder="Current Password" name="cid"
											value="<%=session.getAttribute("id") %>" readonly>
									</div>
									<div class="form-group">
										<label for="cpassword">Customer Name:</label> <input
											type="text" class="form-control" id="cpassword"
											placeholder="Current Password" name="cname"
											value="<%=session.getAttribute("uname") %>" readonly>
									</div>
									<div class="form-group">
										<label for="password">Enter Reason:</label> <input
											type="text" class="form-control" id="password"
											placeholder="Enter You Reason" name="reason" required>
									</div>
