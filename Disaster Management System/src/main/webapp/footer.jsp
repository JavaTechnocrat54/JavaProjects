                            ...
                            <div class="about-footer">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                        <a class="logo1" href="index.html"><span class="sub-logo" style="color: #EB4747;font-family: 'Arima Madurai', cursive;font-size: 2vw;">Disaster <span style="color: #EB4747;font-family: 'Unica One', cursive !important;">Management</span></span></a>
                                    </div> <!--  end col-lg-3-->

                                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                        <p>
                                            Disrupting disaster relief with a complete 360-degree response. Solving complex problems efficiently, with innovative solutions, through smart partnerships.
                                        </p>
                                    </div> <!--  end .col-lg-9  -->
