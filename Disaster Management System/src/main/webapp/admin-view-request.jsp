 ...
 <div id="preloader">
   	...
   	<div class="container">
		...
		<div class="panel panel-info shadow p-3 mb-5">
			<div class="panel-heading">View My Request</div>
			<div class="panel-body">
					...
					<tbody>
						<%
						ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblreq");
						...
						<tr>
							...
							<%
											...
											%>
										<td><a
												href="CustomerRequestStatus.jsp?orderId=<%=resultset.getInt("id")%>"><button
