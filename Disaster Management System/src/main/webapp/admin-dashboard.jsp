							...
							<div class="row">
								...
								<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
									<div class="alert alert-default back-widget-set text-center">
										<%
										int countrequest = 0;
										ResultSet  countrequestCustomers = DatabaseConnection.getResultFromSqlQuery("select count(*) from tblreq");
										...
										<strong style="text-transform: uppercase; font-size: 15px;"><a
											href="admin-view-request.jsp" class="text-dark"
								...
								<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
									<div class="alert alert-default back-widget-set text-center">
										<%
										int countdoner = 0;
										ResultSet rscountdoner = DatabaseConnection.getResultFromSqlQuery("select count(*) from tbldonate");
										rscountdoner.next();
										...
										<strong style="text-transform: uppercase; font-size: 15px;"><a
											href="admin-view-donation.jsp" class="text-dark"
