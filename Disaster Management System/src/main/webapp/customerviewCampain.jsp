...
<head>
        ...
        <link rel="shortcut icon" href="images/logo-one.png" />
            ...
            <div class="container">
                ...
                <div class="row section-heading-wrapper">
                    ...
                    <div class="col-md-12 col-sm-12 text-left no-img-separator">
                        ...
                        <h4>Disrupting disaster relief with a complete 360-degree response. Solving complex problems efficiently, with innovative solutions, through smart partnerships.
                                       </h4> </div> <!-- end .col-sm-12  -->                       
                ...
                <div class="row margin-top-48">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="event-layout-1 theme-custom-box-shadow clearfix"> 
                                <figure class="event-img">
                                    <a href="#">
                                        <img src="images/eventm.jpeg" alt="">
                                    </a>
                                </figure>
                                <div class="event-info"> 
                                    <a class="event-date" href="#"><i class="fa fa-calendar-o"></i> 14 January, 2018</a>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="event-layout-1 theme-custom-box-shadow clearfix"> 
                                <figure class="event-img">
                                    <a href="#">
                                        <img src="images/eventf.jfif" alt="">
                                    </a>
                                </figure>
                                <div class="event-info"> 
                                    <a class="event-date" href="#"><i class="fa fa-calendar-o"></i> 14 January, 2018</a>
                                    <h4>
                                        <a href="#">Food Distribution</a>
                                    </h4>
                                    <div class="event-exceprt">Lorem ipsum dolor sit amet turadipi scing elit lobort issim consecte dign pharetra mauris.</div>
                                    <div class="event-time">
                                        <a href="#"><i class="fa fa-clock-o"></i> 10.00 - 3.00</a>
