...
<nav class="navbar navbar-expand-lg stroke">
	<h2>
		<a class="navbar-brand mr-lg-5" href="index.jsp"> APANA<span>
				BANK
</span>
		</a>
	</h2>
	...
	<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item"><a class="nav-link" href="AdminViewTransaction.jsp">View Transaction</a></li>
			<li class="nav-item"><a class="nav-link" href="admin-view-loan.jsp">Manage 	Loan</a></li>
			<li class="nav-item"><a class="nav-link" href="admin-view-customers.jsp">Manage Customer</a></li>
			<li class="nav-item"><a class="nav-link" href="admin-view-contacts.jsp">Manage Contact</a></li>
