...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-danger">
	...
	<div class="con">
				...
				%>
				<center><font color="black" size="5"><p>Something went wrong!!!Please Try Again.</p></font></center>	
				<%
				}
				%>
				<%
				...
				%>
				<center><font color="black" size="5"><p>Successfully Deleted.</p></font></center>	
				<%
				}
				%>
