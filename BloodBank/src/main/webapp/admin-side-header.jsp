		...
		<div class="navbar navbar-default">
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a class="logo" href="admin-dashboard.jsp"><span class="sub-logo"
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="admin-dashboard.jsp" title="Home">Home</a></li>

						

						
						
						<li class="drop"><a href="admin-view-bloodrequest.jsp">ViewRequest</a>
						<li class="drop"><a href="admin-view-donation.jsp">ViewDonation</a>
							</li>

					<li><a href="admin-manage-stock.jsp">Stock</a></li>
						<li><a href="#"><%=session.getAttribute("uname")%></a>
							<ul class="drop-down">

								<li class="drop"><a href="admin-veiw-profile.jsp">MyProfile</a></li>
								
								<li><a href="admin-change-password.jsp" title="FAQ">Setting</a></li>
