	...
	<div class="container-fluid">
		...
		<div class="panel panel-warning shadow p-3 mb-5">
			<div class="panel-heading"
				...
				View Your Request &nbsp;&nbsp;&nbsp;&nbsp;[&nbsp;<%=(new java.util.Date()).toLocaleString()%>&nbsp;]&nbsp;&nbsp;
			...
			<div class="panel-body">
				...
				<table id="table" class="table table-bordered">
					...
					<tbody>
						<%
						ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblrequest");
						while (resultset.next()) {
						%>

						<tr>
							<td><%=resultset.getInt("reqid")%></td>
							<td><%=resultset.getString("username")%></td>
							<td><label style='color: #33b5e5;'><%=resultset.getString("userid")%></label></td>


							<td><%=resultset.getString("bloodg")%></td>
							...
							<%
											...
											%>
										<td><a
												href="CustomerRequestStatus.jsp?orderId=<%=resultset.getInt("reqid")%>"><button
