			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="panel panel-warning shadow p-3 mb-5">
						<div class="panel-heading">RequestBllod</div>
						<div class="panel-body">
							...
							%>
							<div class="alert alert-successs" id="danger">Your Requst Is Send To Successfully.</div>
							<%
							}
							%>
							<%
							...
							%>
							<div class="alert alert-info" id="info">SomeThing Went Wrong .</div>
							<%
							}
							%>
							<form action="CustomerReq" method="post">
								<div class="row">
									<div class="form-group col-md-6">
										<%
										int requestId = DatabaseConnection.generateCustomerId();
										%>
										<label for="uname">Request Id:</label> <input type="text"
								...
								<div class="row">
									<div class="form-group col-md-6">
										<label for="uname">BloodGroup:</label> <label for="gender">Select
											Blood:</label> <select class="form-control" id="gender" name="bloodg">
											<option>A+</option>
											<option>O+</option>
											<option>B+</option>
											<option>AB+</option>
								...
								<div class="form-group">
									<lable for="description">Message</lable>
									<textarea class="form-control" id="msg"
										placeholder="Enter message" name="msg" required="required"></textarea>
								</div>
