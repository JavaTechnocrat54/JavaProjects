                            ...
                            <div class="about-footer">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                        <a class="logo1" href="index.html"><span class="sub-logo" style="color: #EB4747;font-family: 'Arima Madurai', cursive;font-size: 2vw;">Blood <span style="color: #EB4747;font-family: 'Unica One', cursive !important;">BANK</span></span></a>
                                    </div> <!--  end col-lg-3-->
