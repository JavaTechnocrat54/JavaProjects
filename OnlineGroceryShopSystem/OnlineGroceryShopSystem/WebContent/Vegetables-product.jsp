...
<body>
	...
	<div class="men-wear">
		<div class="container">
			<div class="container">
				<h2>
					<span><center>All Vegetables Products</center></span>
				</h2>
			</div>
			<%
			ResultSet retriveProduct = DatabaseConnection
			.getResultFromSqlQuery("select * from tblproducts where catagory='Vegetables'");
				...
				<div class="men-pro-item simpleCart_shelfItem">
					<div class="men-thumb-item">
						<input type="hidden" name="productId"
							...
							src="AddProducts?id=<%=retriveProduct.getInt("id")%>"
