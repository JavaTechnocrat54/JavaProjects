		...
		<div class="container">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<%
						ResultSet totalProduct = DatabaseConnection.getResultFromSqlQuery("select tblproducts.id,tblproducts.pname,tblcart.quantity,tblcart.mrp_price,tblcart.discount_price,tblcart.total_price,tblcart.product_id from tblproducts,tblcart where tblproducts.id=tblcart.product_id and customer_id='"
					...
					<tr class="rem1">
						...
						<td class="invert"><img
							src="AddProducts?id=<%=totalProduct.getInt("id")%>" alt=""
							class="pro-image-front" style="width: 150px; height: 100px;"><br><%=totalProduct.getString("pname")%></td>
						<td class="invert">
							<div class="quantity">
