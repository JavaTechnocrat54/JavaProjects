	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			ResultSet totalMedicine = DatabaseConnection.getResultFromSqlQuery(
					"select tblmedicine.medicine_image,tblmedicine.medicine_name,tblcart.quantity,tblcart.medicine_mrp_price,tblcart.medicine_discount_price,tblcart.total_medicines_price,tblcart.medicine_id,tblmedicine.id from tblmedicine,tblcart where tblmedicine.id=tblcart.medicine_id and customer_id='"
			...
			while (totalMedicine.next()) {
				...
				int updateMedicineQuantityInMedicine = DatabaseConnection
						.insertUpdateFromSqlQuery("update tblmedicine set medicine_quantity= medicine_quantity-'"
