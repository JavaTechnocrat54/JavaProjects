...
public class CheckoutController {
	...
	public String placeOrder(HttpServletRequest request) throws CustomerNotFoundException {
		...
		/*
		 * try { OrderUtil.sendOrderConfirmationEmail(request, createdOrder,
		 * settingService); } catch (UnsupportedEncodingException | MessagingException
		 * e) { // TODO Auto-generated catch block LOGGER.
		 * info("CheckoutController | placeOrder | OrderUtil.sendOrderConfirmationEmail failed"
		 * ); e.printStackTrace(); }
		 */
