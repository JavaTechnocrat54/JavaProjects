   ...
   <!-- Page Header Start -->
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">ViewAPPOIMENT</h1>
		...
		<div class="">
			<div class="page-title">
				<div class="title_left">
					<h3>
						<i class="fa fa-medkit"></i> APPOIMENT
					</h3>
				</div>
			</div>
			...
			%>
			<div class="alert alert-info" id="info">APPOIMENT information updated.</div>
			<%
				}
			%>
			<%
				String deleteAPPOIMENT = (String) session.getAttribute("APPOIMENT");
				if (deleteAPPOIMENT != null) {
				session.removeAttribute("APPOIMENT");
			%>
			<div class="alert alert-danger" id="danger">APPOIMENT deleted.</div>
			<%
				}
			%>
			<div class="row">
								...
								<tbody>
									<tr>
										...
										<%
											...
											%>
										<td><a
												href="CustomerBookingStatus?orderId=<%=resultset.getInt("id")%>"><button
