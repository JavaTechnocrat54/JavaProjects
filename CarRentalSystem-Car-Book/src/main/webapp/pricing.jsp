			...
			<div class="container">
    			...
    			<div class="col-md-12 ftco-animate">
    				<div class="car-list">
						...
						%>
						      <tr class="">
						      	<td class="car-image"><div class="img" style="background-image:url('AdminAddCar?id=<%=resultSet.getInt("carid")%>');"></div></td>
						        <td class="product-name">
						        	<h3><%=resultSet.getString("model") %></h3>
						        	<p class="mb-0 rated">
						        		<span>rated:</span>
						        ...
						        <td class="price">
						        	...
						        	<div class="price-rate">
							        	<h3>
							        		<span class="num"><small class="currency">R</small> <%=resultSet.getInt("oned") %></span>
						        ...
						        <td class="price">
						        	...
						        	<div class="price-rate">
							        	<h3>
							        		<span class="num"><small class="currency">R</small> <%=resultSet.getInt("onew") %></span>
						        ...
						        <td class="price">
						        	...
						        	<div class="price-rate">
							        	<h3>
							        		<span class="num"><small class="currency">R</small> <%=resultSet.getInt("onem") %></span>
