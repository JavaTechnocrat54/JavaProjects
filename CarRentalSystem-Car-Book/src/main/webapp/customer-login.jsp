		...
		<div class="container">
			<div
				...
				<div class="col-md-9 ftco-animate pb-5">
					...
					<h1 class="mb-3 bread">Customer Login</h1>
				</div>
			</div>
		</div>
	</section>
							...
							<form action="CustomerLogin" method="post">
								...
								<div class="form-row">
									<div class="form-group col-md-6">
										<div class="form-group">
											<label for="upass">VarIfication</label> <input type="password"
												class="form-control" id="upass" placeholder="Enter password"
												name="vercode" required>
										</div>
									</div>
									<div class="form-group col-md-6"><div class="form-group">
										<label for="upass">Password:</label> <input type="text"
											class="form-control" id="upass" placeholder="Enter password"
											name="vercode"  value="<%=captcha%>"required readonly >
									</div></div>
								...
								Dont have A Account<a href="customer-account.jsp">Register</a>
							</form>
						</div>
					</div>
				</div>
