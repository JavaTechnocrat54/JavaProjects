...
<head>
<title>Carbook</title>
<link rel="icon" href="images/Carrental-logo.jpg" sizes="32x32">
<meta charset="utf-8">
<meta name="viewport"
...
%>
						...
						<div class="col-md-4 d-flex align-items-center">
							<form action="#" class="request-form ftco-animate bg-primary">
								...
								<div class="form-group">
									<label for="" class="label">Pick-up location</label> <input
										type="text" class="form-control"
										placeholder="City, Airport, Station, etc">
								</div>
								<div class="form-group">
									<label for="" class="label">Drop-off location</label> <input
										type="text" class="form-control"
										placeholder="City, Airport, Station, etc">
								</div>
								<div class="d-flex">
						...
						<div class="item">
							<div class="car-wrap rounded ftco-animate">
								<div class="img rounded d-flex align-items-end"
									style="background-image: url('AdminAddCar?id=<%=resultSet.getInt("carid")%>');"></div>
								<div class="text">
									<h2 class="mb-0">
										<a href="#"><%=resultSet.getString("model") %></a>
									</h2>
	...
	<jsp:include page="font-side-footer.jsp"></jsp:include>
