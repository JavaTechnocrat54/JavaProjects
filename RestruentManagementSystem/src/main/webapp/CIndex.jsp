	...
	<header id="header" class="fixed-top d-flex align-items-center ">
		<div
			...
			<nav id="navbar" class="navbar order-last order-lg-0">
				<ul>
					<li><a class="nav-link scrollto " href="Cindex.jsp">Home</a></li>

 <li class="dropdown"><a href="#"><span><%=name %></span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="viewOreder.jsp">MyOrder</a></li>
              
              <li><a href="Viewbooking.jsp">MyTableBooking</a></li>
              <li><a href="ViewEvent.jsp">MyEventBooking</a></li>
		...
		<section class="breadcrumbs">
			<div class="container">
				...
				<div class="d-flex justify-content-between align-items-center">
					...
					String message = (String) session.getAttribute("user-msg");
					if (message != null) {
					...
					<h2>
						...
						<%=name%></h2>
					<ol>
						<li><a href="CIndex.jsp">UserHome</a></li>
						<li>Dashbord</li>
					</ol>
				</div>
		...
		<section class="inner-page">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 form-group">
						<div class="alert alert-info back-widget-set text-center">
							<a href="BookTable.html"> <i class="fas fa-bookmark fa-5x"
					...
					<div class="col-md-6 form-group mt-3 mt-md-0">
						<div class="alert alert-info back-widget-set text-center">
							<a href="OrderOnline.html"> <i
								class="fa-solid fa-pizza-slice fa-5x" aria-hidden="true"></i></a>
							<h2>Order Online</h2>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-6 form-group">
						<div class="alert alert-info back-widget-set text-center">
							<a href="viewProfile.jsp"> <i class="fa-solid fa-user fa-5x"
								aria-hidden="true"></i></a>
							<h2>ViewProfile</h2>
						</div>
					</div>
					<div class="col-md-6 form-group mt-3 mt-md-0">
						<div class="alert alert-info back-widget-set text-center">
							<a href="Bookevent.html"> <i
								class="fa-solid fa-champagne-glasses fa-5x" aria-hidden="true"></i></a>
							<h2>Book Events</h2>
						</div>
					</div>
				</div>
