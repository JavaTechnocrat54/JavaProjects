...
<body>
  ...
  <main id="main">
   ...
   ResultSet rs=DatabaseConnection.getResultFromSqlQuery("select * from tblevent ");
   while(rs.next())
   {	
   %>
     <tr>
     <td><%=rs.getInt(1) %></td>
       ...
       <td><%=rs.getString(9) %></td>
     	<%
						...
						<td><a href="DelateEvent.jsp?orderId=<%=rs.getInt(1)%>" class="btn btn-danger">Delate</a></td>
						</tr>
						<%
						}
						%>
