		...
		<div
			...
			<nav id="navbar" class="navbar order-last order-lg-0">
				<ul>
					...
					<li><a class="nav-link scrollto" href="index.jsp#menu">Menu</a></li>
					<li><a class="nav-link scrollto" href="index.jsp#specials">Specials</a></li>
					<li><a class="nav-link scrollto" href="index.jsp#events">Events</a></li>
					<li><a class="nav-link scrollto" href="index.jsp#chefs">Chefs</a></li>
					<li><a class="nav-link scrollto" href="index.jsp#gallery">Gallery</a></li>
	...
	<main id="main">
		...
		<section class="inner-page">
			...
			if(creg!=null){
				...
				><%=creg %><a href="Login.html">Login</a></div>
					...
					<div class="row">
						...
						<div class="col-md-6 form-group mt-3 mt-md-0">
							<input type="text" class="form-control" name="pincode"
								id="pincode" placeholder="Your PinCode" required>
						</div>
					</div>
					<div class="row">
