...
<body>
	<div class="site-wrap">
				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Create Farmer Account</strong>
					</div>
				</div>
			</div>
		</div>
		<div class="site-section">
			<div class="container">
				<%
					String customerAccount = (String) session.getAttribute("farmer-account");
				if (customerAccount != null) {
					session.removeAttribute("customer-account");
				%>
				<div class="alert alert-info" id="info">Farmer account
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-warning shadow p-3 mb-5">
							<div class="panel-heading">Farmer Account</div>
							<div class="panel-body">
								<form action="FarmerAccount" method="post" name="customerForm">
									<div class="form-row">
										<%
											int customerId = DatabaseConnection.generateCustomerId();
										%>
										<div class="form-group col-md-6">
											<label for="customerId">Farmer Id:</label> <input
												type="text" class="form-control" id="customerId"
												placeholder="Farmer Id" name="customerId"
