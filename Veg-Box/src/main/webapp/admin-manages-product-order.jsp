							...
							<table id="datatable" class="table table-striped table-bordered">
								...
								<tbody>
									<tr>
										...
										<td><img src="GetProductOrders?name=<%=resultOrders.getString("medicine_name")%>"
										...
										%>
										<td><a href="admin-manage-product-details.jsp?orderNo=<%=resultOrders.getInt("order_no")%>" class="btn btn-info">View Details</a></td>
									</tr>
								</tbody>
								<%
									}
