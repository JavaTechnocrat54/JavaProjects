					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-warning shadow p-3 mb-5">
							...
							<div class="panel-body">
								...
								%>
								<form action="FarmerEditProfile" method="post">
									<div class="form-row">
										<%
											ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblfarmer where uname='" + session.getAttribute("uname") + "' OR email_id='"+session.getAttribute("email")+"'");
											if (resultset.next()) {
										%>
