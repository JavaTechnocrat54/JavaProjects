		...
		<div class="">
			<div class="page-title">
				<div class="title_left">
					<h4>
						<i class="fa fa-medkit"></i> View Product Order Details
						</h3>
				</div>
			</div>
			...
			<div class="x_panel">
				...
				<div class="x_content shadow p-3 mb-5">
					<form role="form" action="CustomerProductOrderStatus" method="post">
						<div class="form-row">
						...
						<div class="form-row">
							...
							<div class="col-md-4 col-sm-4">
								<div class="form-group">
									<label>Product MRP</label> <input class="form-control"
										type="text" name="medicineMrp" value="<%=resultset.getString("medicine_mrp_price")%>" readonly>
								</div>
							</div>
							<div class="col-md-4 col-sm-4">
								<div class="form-group">
									<label>Product Discount Price</label> <input class="form-control"
						...
						<div class="form-row">
							...
							<div class="col-md-4 col-sm-4">
								<div class="form-group">
									<label>Product Total Price</label> <input class="form-control"
						...
						<div class="form-row">
							<div class="col-md-8 col-sm-8">
								<div class="form-group">
									<label>Medicine Image</label> <image src="GetProductOrders?name=<%=resultset.getString("medicine_name")%>"
