				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <a
							href="continue-product-shopping.jsp">Continue 
							Shopping</a>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="form-group row">
						<div class="col-md-2">
							<a href="dairy-product.jsp" class="btn btn-primary" style="text-transform: lowercase;">Already same Product added in cart, Choose different Product to add cart, click here to another Product.</a>
						</div>
					</div>
				</div>
			</div>
