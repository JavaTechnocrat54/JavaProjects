				...
				<div class="row mb-5 shadow p-3 mb-5">
					<div class="site-blocks-table">
						<table class="table table-bordered">
							...
							<%
								ResultSet totalMedicine = DatabaseConnection.getResultFromSqlQuery("select tblproduct.id,tblproduct.medicine_name,tblcart.quantity,tblcart.medicine_mrp_price,tblcart.medicine_discount_price,tblcart.total_medicines_price,tblcart.medicine_id from tblproduct,tblcart where tblproduct.id=tblcart.medicine_id and customer_id='"+ session.getAttribute("customerId") + "'");
