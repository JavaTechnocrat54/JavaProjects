					...
					<div class="x_panel">
						...
						<div class="x_content">
							<table id="datatable" class="table table-striped table-bordered"
								...
								<%
									ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblproduct");
									while (resultset.next()) {
								%>
								<tbody>
									<tr>
										<td><%=resultset.getInt("id")%></td>
										<td><image src="AdminAddProduct?id=<%=resultset.getInt("id")%>"
										...
										%>
										<td><a
											href="admin-view-product-details.jsp?medicineId=<%=resultset.getInt("id")%>"
											class="btn btn-sm btn-info text-white"><i
												class="fa fa-eye"></i> details</a> <a
											href="admin-edit-product.jsp?medicineId=<%=resultset.getInt("id")%>"
