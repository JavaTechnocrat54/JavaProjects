...
<body>
	<div class="site-wrap">
		...
		<div class="site-section">
			<div class="container">
				<%
					ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblproduct where id='" + request.getParameter("id") + "'");
					if (resultset.next()) {
				%>
						...
						<div class="col-md-5 mr-auto">
							<div class="border text-center">
								<input type="hidden" name="medicineId"
									...
									src="AdminAddProduct?id=<%=resultset.getInt("id")%>"
