	...
	<div class="site-wrap">
		...
		<div class="site-section">
			<div class="container">
				...
				<br> <br>
				<%
					ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblproduct where medicine_name like '%" + request.getParameter("search") + "%'");
					while (resultset.next()) {
				%>
				<div class="row">
					<div class="col-md-5 mr-auto">
						<div class="border text-center">
							<img src="AdminAddProduct?id=<%=resultset.getInt("id")%>" alt="Image"
								class="img-fluid p-5">
						</div>
					</div>
					<div class="col-md-6">
						...
						<p>Manufacturing Date - <%=resultset.getString("created_at") %></p>
