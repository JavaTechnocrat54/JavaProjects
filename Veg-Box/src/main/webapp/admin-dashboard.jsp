							...
							<div class="row">
								<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
									<div class="alert alert-default back-widget-set text-center">
										<%
											...
											ResultSet rsMedicines = DatabaseConnection.getResultFromSqlQuery("select count(*) from tblproduct");
											rsMedicines.next();
										...
										<strong style="text-transform: uppercase; font-size: 15px;"><a
											href="admin-view-product.jsp" class="text-dark" target="_blank">Manage Product</a></strong>
									</div>
								</div>
								<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
									<div class="alert alert-default back-widget-set text-center">
										...
										<strong style="text-transform: uppercase; font-size: 15px;"><a
											href="admin-manages-product-order.jsp" class="text-dark" target="_blank">Total Orders</a></strong>
									</div>
								</div>
								<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
									<div class="alert alert-default back-widget-set text-center">
								...
								<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
									<div class="alert alert-default back-widget-set text-center">
										...
										<h3>
											<font color="#FF9933"><span class="counter">&nbsp;Rs/-</span></font>
										</h3>
										<strong style="text-transform: uppercase; font-size: 15px;"><a
							...
							<div class="row">
								...
								<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
									<div class="alert alert-default back-widget-set text-center">
										...
										<h3>
											<font color="#FF9933"><span class="counter"></span></font>
										</h3>
										<strong style="text-transform: uppercase; font-size: 15px;"><a
											href="admin-manages-product-order.jsp" class="text-dark" target="_blank">Pending Orders</a></strong>
									</div>
								</div>
								<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
									<div class="alert alert-default back-widget-set text-center">
										...
										<strong style="text-transform: uppercase; font-size: 15px;"><a
											href="admin-viewfarmer-sell.jsp" class="text-dark" target="_blank">FarmerSell</a></strong>
									</div>
								</div>
								<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
									<div class="alert alert-default back-widget-set text-center">
										...
										<strong style="text-transform: uppercase; font-size: 15px;"><a
											href="admin-manages-product-order.jsp" class="text-dark" target="_blank">Delivered Orders</a></strong>
									</div>
								</div>
							</div>
						</div>
