		...
		<div class="">
			<div class="page-title">
				<div class="title_left">
					<h4>
						<i class="fa fa-bullseye"></i> Add Medicine
					</h3>
				</div>
			</div>
			...
			<div class="x_panel">
				...
				<div class="x_content shadow p-3 mb-5">
					<form role="form" action="AdminAddProduct" method="post"
							...
							<div class="col-md-6 col-sm-6">
								...
								<div class="form-group">
									<label>Product Id</label> <input class="form-control"
										type="text" name="productId" value="<%=medicineId%>" readonly>
								</div>
							</div>
							<div class="col-md-6 col-sm-6">
								<div class="form-group">
									<label>Select Product Type</label> <select
										class="form-control" name="mType">
										<option>Dairy products</option>
										<option>Vegetables products</option>
										<option>Fruit products</option>
									</select>
							...
							<div class="col-md-12 col-sm-12">
								<div class="form-group">
									<label>Product Name</label> <input class="form-control"
										type="text" name="mName" placeholder="Product Name">
								</div>
							</div>
						</div>
						<div class="form-row">
							...
							<div class="col-md-4 col-sm-4">
								<div class="form-group">
									<label>Quantity</label> <input class="form-control" type="text"
										name="mQuantity" placeholder="Product Quantity">
								</div>
							</div>
						</div>
						<div class="form-row">
