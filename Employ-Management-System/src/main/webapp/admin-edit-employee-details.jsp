					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-warning shadow p-3 mb-5">
							...
							<div class="panel-body">
								<form action="AdminEditEmployee" method="post" name="employeeForm">
									<div class="row">
										<%
									...
									%>
										...
										<div class="form-group col-md-6"">
											<label for="cname">Full Name:</label> <input type="text"
												...
												name="cname" value="<%=resultset.getString("name")%>" required >
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-6">
											<label for="email">Email Id:</label> <input type="text"
												...
												name="email"  value="<%=resultset.getString("email")%>" required > <span id="emailloc"></span>
										</div>
										<div class="form-group col-md-6">
											<label for="mobile">Mobile No:</label> <input type="text"
												class="form-control" id="mobile" placeholder="Mobile No"
												name="mobile"  value="<%=resultset.getString("mobile")%>" required maxlength="10" >
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-6">
									...
									<div class="row">
										<div class="form-group col-md-6">
											...
											<textarea class="form-control" id="address"
												placeholder="Address"  name="address"  required maxlength="60"><%=resultset.getString("address")%></textarea>
										</div>
										<div class="form-group col-md-6">
											<label for="pincode">Pincode:</label> <input type="text"
												class="form-control" id="pincode"
												placeholder="Enter Pincode" name="pincode" value="<%=resultset.getString("pincode")%>" required 
												 maxlength="6">
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-6">
											<label for="uname">Salary:</label> <input type="text"
												...
												name="salary" value="<%=resultset.getString("scalary")%>"required >
										</div>
										<div class="form-group col-md-6">
											<label for="gender">Select Status:</label> <select
												class="form-control" id="gender" name="status" >
