...
public class RoleRepositoryTest {
	...
	@Test
	public void testCreteFirstRole() {
	...
	public void testCreateRestRoles()
	{
		...
		Role roleEditor=new Role("Editor","manage categories,brands,"+"products,ariticles and menus");
		
		Role roleShipper=new Role("Shipper","view Products,vieworder"+"and update order status");
		
		Role roleAssistent=new Role("Assistant","manage questions and reviews");
