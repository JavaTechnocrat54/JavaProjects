	...
	<div class="wrapper">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12">
					<div class="card-box">
						<h4 class="m-t-0 header-title">Complaint Status</h4>
						<table id="datatable"
							...
							<%
								ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblcomplaints where member_name='" + session.getAttribute("memberName") + "'");
							...
							<tbody>
								<tr>
									...
									<td><%=resultset.getString("admin_remark") %></td>
									<%
										if (resultset.getString("complaint_status").equals("Resolved")) {
									%>
									<td><font color="green"><%=resultset.getString("complaint_status")%></font></td>
									<%
										} else if (resultset.getString("complaint_status").equals("Pending")) {
									%>
									<td><font color="red"><%=resultset.getString("complaint_status")%></font></td>
									<%
										} else {
									%>
									<td><font color="blue"><%=resultset.getString("complaint_status")%></font></td>
									<%
										}
									%>
								</tr>
