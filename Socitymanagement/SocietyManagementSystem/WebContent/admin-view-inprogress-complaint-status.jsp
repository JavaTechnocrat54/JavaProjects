...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="header">
				<h1 class="page-header">View Complaints Status</h1>
				<ol class="breadcrumb">
						...
						<div class="panel-body">
							<div class="panel panel shadow p-3 mb-5 ">
								<div class="panel-heading bg-light"
									...
									<strong>View Complaints Status &nbsp;[&nbsp;<%=(new java.util.Date()).toLocaleString()%>&nbsp;]&nbsp;&nbsp;
									</strong>
								</div>
								<%
										...
										<div class="form-row">
											<div class="form-group col-md-12">
												...
												<textarea type="text" class="form-control" id="remark"
													name="remark" readonly><%=resultset.getString("admin_remark")%></textarea>
											</div>
										</div>	
									</form>
								</div>
