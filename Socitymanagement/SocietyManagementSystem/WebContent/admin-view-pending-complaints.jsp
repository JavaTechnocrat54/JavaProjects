...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="header">
				<h1 class="page-header">Pending Complaints</h1>
				<ol class="breadcrumb">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">Pending Complaints</div>
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover"
										...
										<%
											ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblcomplaints where complaint_status='Pending'");
										...
										<tbody>
											<tr class="odd gradeX">
												...
												%>
												<td><a href="admin-view-complaints-details.jsp?compId=<%=resultset.getInt("complaint_id")%>">View Details</a></td>
											</tr>
										</tbody>
										<%
											}
