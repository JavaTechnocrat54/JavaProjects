...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="header">
				<h1 class="page-header">In Progress Complaints</h1>
				<ol class="breadcrumb">
					<li><a href="admin-dashboard.jsp">Home</a></li>
					<li><a href="admin-view-inprogress-complaints.jsp">In Progress Complaints</a></li>
				</ol>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">In Progress Complaints</div>
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover"
										...
										<%
											ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblcomplaints where complaint_status='In Progress'");
										...
										<tbody>
											<tr class="odd gradeX">
												...
												%>
												<td><a href="admin-view-inprogress-complaint-status.jsp?compId=<%=resultset.getInt("complaint_id")%>">View Details</a></td>
											</tr>
										</tbody>
										<%
											}
