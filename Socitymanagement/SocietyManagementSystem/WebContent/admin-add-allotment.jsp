...
<script>
	function myFunction() {
		...
		document.location.href = "admin-add-allotment.jsp?block=" + block;
	}
</script>
</head>
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="header">
				<h1 class="page-header">Add Allotment</h1>
				<ol class="breadcrumb">
					<li><a href="admin-dashboard.jsp">Home</a></li>
					<li><a href="admin-add-allotment.jsp">Fill Allotment
							Details</a></li>
				</ol>
			</div>
			<div id="page-inner">
						...
						<div class="panel-body">
							<div class="panel panel shadow p-3 mb-5 ">
								<div class="panel-heading bg-light"
									...
									<strong>Fill Allotment Details &nbsp;[&nbsp;<%=(new java.util.Date()).toLocaleString()%>&nbsp;]&nbsp;&nbsp;
									</strong>
								</div>
								<div class="panel-body">
									<form action="AddAllotment" method="post">
										<div class="form-row">
											<div class="form-group col-md-12">
												<%
													String flatAllot = (String) session.getAttribute("success");
													if (flatAllot != null) {
														session.removeAttribute("success");
												%>
												<div class="alert alert-success" id="success">Flat alloted successfully.</div>
												<%
													}
												%>
										...
										<div class="form-row">
											<div class="form-group col-md-12">
												...
												<input type="text" class="form-control"
													id="emergency-mobile" name="emergencyMobile"
										...
										<div class="form-row">
											<div class="form-group col-md-12">
												<label for="totalFamilyMembers">Total Members of
													...
													id="totalFamilyMembers" name="totalFamilyMembers"
													placeholder="Total Members of Family" required>
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-12">
												...
												<textarea class="form-control" id="address" name="address"
													placeholder="Permanent Address (If any)" required></textarea>
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-12">
