		...
		<div id="page-wrapper">
			<div class="header">
				...
				<ol class="breadcrumb">
					...
					<li><a href="admin-view-visitors-between-dates.jsp">View Visitors</a></li>
				</ol>
								...
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover"
										...
										<%
											...
											ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblvisitors where created_at between '"+date1+"' and '"+date2+"'");
