...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="header">
				<h1 class="page-header">Search Allotments</h1>
				<ol class="breadcrumb">
					<li><a href="admin-dashboard.jsp">Home</a></li>
					<li><a href="admin-search-allotments.jsp">Search Allotments
							</a></li>
				</ol>
			</div>
			<div id="page-inner">
						...
						<div class="panel-body">
							<div class="panel panel shadow p-3 mb-5 ">
								<div class="panel-heading bg-light"
									...
									<strong>Search Allotments &nbsp;[&nbsp;<%=(new java.util.Date()).toLocaleString()%>&nbsp;]&nbsp;&nbsp;
									</strong>
								</div>

								<div class="panel-body">
									<form action="admin-view-all-allotments.jsp" method="post">
										<div class="form-row">
